...
from openai_utils import process_response, generate_chatglm3, generate_stream_chatglm3
...
if __name__ == "__main__":
    ...
    if 'cuda' in DEVICE:  # AMD, NVIDIA GPU can use Half Precision
        model = AutoModel.from_pretrained(
            MODEL_PATH, trust_remote_code=True, device=DEVICE).quantize(QUANTIZE).half().eval()
